  ...
  <section class="tags-section">
    <el-card class="tags-card">
      ...
      <el-dialog v-if="assignTagDialogVisible" v-model="assignTagDialogVisible" :title="assignTagTitle"
        ...
        <el-table v-if="assignTag.type === 'paperReviewer'" :data="paperReviewerList.records"
          ref="paperReviewerTableRef" :row-key="getRowKey" @select="handlePaperReviewerSelect" empty-text="查無資料">
          <el-table-column type="selection" width="55" :reserve-selection="true" />
